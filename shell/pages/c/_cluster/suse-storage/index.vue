        ...
        return [
          {
            ...
            label:       'suseStorage.overview.linkedList.label', // i18n-uses longhorn.overview.linkedList.longhorn.label
            description: 'suseStorage.overview.linkedList.description', // i18n-uses longhorn.overview.linkedList.longhorn.description
...
<template>
  ...
  <section v-else>
    ...
    >
      <template #message>
        <p>
          {{ t('suseStorage.overview.linkedList.uiServiceUnavailable') }}
        </p>
      </template>
    </IconMessage>
  </section>
